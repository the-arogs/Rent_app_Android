...
import com.rg.rentapp.databinding.ActivityAddRentalBinding
...
class AddRentalActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddRentalBinding.inflate(layoutInflater)
        ...
        this.binding.swCurrLocation.setOnClickListener {
            if ( binding.swCurrLocation.isChecked) {
                getDeviceLocation()
                Log.d(TAG, "onCreate: Switch turned on")
            } else {
                binding.etAddress.setText("")
                Log.d(TAG, "onCreate: Switch turned off")
            }
        }

        this.binding.btnPost.setOnClickListener {
